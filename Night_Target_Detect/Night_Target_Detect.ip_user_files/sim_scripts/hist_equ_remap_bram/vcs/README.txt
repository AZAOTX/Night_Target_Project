...
#
# Generated by export_simulation on Thu Oct 17 15:47:23 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './hist_equ_remap_bram.sh' script.

./hist_equ_remap_bram.sh -reset_run
...
./hist_equ_remap_bram.sh -noclean_files

For more information on the script, please type './hist_equ_remap_bram.sh -help'.
