...
#
# Generated by export_simulation on Sat Oct 26 10:03:37 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './hist_static_bram.sh' script.

./hist_static_bram.sh -reset_run
...
./hist_static_bram.sh -noclean_files

For more information on the script, please type './hist_static_bram.sh -help'.
