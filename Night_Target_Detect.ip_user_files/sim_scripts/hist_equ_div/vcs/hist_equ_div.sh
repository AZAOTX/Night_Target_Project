...
#
# Generated by Vivado on Sat Oct 26 10:00:04 +0800 2024
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: hist_equ_div.sh [-help]
# usage: hist_equ_div.sh [-lib_map_path]
# usage: hist_equ_div.sh [-noclean_files]
# usage: hist_equ_div.sh [-reset_run]
#
...
# executing this script. Please type 'hist_equ_div.sh -help' for more information.
#
...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm xbip_utils_v3_0_9 axi_utils_v2_0_5 xbip_pipe_v3_0_5 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_5 xbip_bram18k_v3_0_5 mult_gen_v12_0_14 floating_point_v7_0_15 xbip_dsp48_mult_v3_0_5 xbip_dsp48_multadd_v3_0_5 div_gen_v5_1_14)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "hist_equ_div.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../OV5640_TFT.srcs/sources_1/ip/hist_equ_div/sim/hist_equ_div.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.hist_equ_div xil_defaultlib.glbl -o hist_equ_div_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./hist_equ_div_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./hist_equ_div.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key hist_equ_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc hist_equ_div_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./hist_equ_div.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: hist_equ_div.sh [-help]\n\
Usage: hist_equ_div.sh [-lib_map_path]\n\
Usage: hist_equ_div.sh [-reset_run]\n\
Usage: hist_equ_div.sh [-noclean_files]\n\n\
